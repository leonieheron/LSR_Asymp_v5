...
postnew <- function(id, user, sbreport,sbselect,sbcomments,rrselect1,rrselect2,rrcomment1,rrcomment2,rrcomment3,rrcomment4,sbrrselect,sbrrcomment,ibcomment,ibselect,ibcomment2,ibselect2,ibcomment3,ibcheck1,ibcheck2,ibcheck3,ibcheck4,ibcheck5,ibcomment4,ibselect3,ibcomment5,siselect1,siselect2,sicomment,fcselect,fccomment,robcluster,sbreportc2,sbselectc2,rrselect1c2,rrselect2c2,rrcomment1c2,rrcomment2c2,rrcomment3c2,sbrrselectc2,ibselectc2,ibselect2c2,ibcheck1c2,ibcheck2c2,ibcheck3c2,ibcheck4c2,ibcheck5c2,ibcheck6c2,ibselect3c2,siselect1c2,siselect2c2,fcselectc2){
  data_redcap <- paste0('record_id, rob_reviewer_2, r2_target_pop, r2_rob_q1, r2_comment_1, r2_response_rate, r2_response_calc, r2_participants, r2_eligible, r2_response_prop,r2_response_comment, r2_rob_q2, r2_comment_2, r2_symp_def, r2_rob_q3,r2_comment_3,r2_rob_q4,r2_comment_4,r2_follow_up___1,r2_follow_up___2,r2_follow_up___3,r2_follow_up___4,r2_follow_up___5,r2_viral_load,r2_rob_q5,r2_comment_5,r2_symp_stat,r2_rob_q6,r2_comment_6,r2_risk,r2_comment_7,rob_cluster_desc_2,r2_target_pop_c2,r2_rob_q1_c2,r2_response_rate_c2,r2_response_calc_c2,r2_participants_c2,r2_eligible_c2,r2_response_prop_c2,r2_rob_q2_c2,r2_rob_q3_c2,r2_rob_q4_c2,r2_follow_up_c2___1,r2_follow_up_c2___2,r2_follow_up_c2___3,r2_follow_up_c2___4,r2_follow_up_c2___5,r2_follow_up_c2___6,r2_rob_q5_c2,r2_symp_stat_c2,r2_rob_q6_c2,r2_risk_c2\n',
...
server <- function(input, output, session){
  ...
  observeEvent(input$add, {
    ...
    if(login){
      ...
      #subsetting of the data should be improved
      redcapdb<-subset(redcapdb, redcapdb$rob_reviewer_2==user  & redcapdb$r2_target_pop=="" & redcapdb$r2_comment_1=="")
        ...
        insertUI(
          ...
          ui = fluidPage(id= paste0("rcid_",redcapdb$id[i]),
            column(9, br(),
                   ...
                   #Response Rate
                   HTML("<b><mark style=\"background-color:#FFFFE0\"><font size=6>Response Rate</font><br></mark><font size=2><span style=\"font-weight:normal\">Response rate: The number of completed or returned survey instruments (questionnaires, interviews, etc.) divided by the total number of persons who would have been surveyed if all had participated. Usually expressed as a percentage (Porta M. A Dictionary of Epidemiology, 2014)</font></span></b><br><br>"), #LH: Can you make this small text a bit bigger?
                   ...
                   selectInput(paste0("rrselect2",redcapdb$id[i]), HTML("If the response rate is NOT provided, can you calculate the response rate?<font color=\"#FF0000\"> *</font>. If numbers are not reported, please write 'NA'"), #LH: Text changed
                               choices = c("Yes" = 1, "No" = 2, "NA" = 3),
                               selected = FALSE,
                               multiple = FALSE,
                               selectize = FALSE, size = 2, width = 380),
                   #r2_response_calc_c2
                   selectInput(paste0("rrselect2c2",redcapdb$id[i]),HTML("<font color=\"#0066CC\">If the response rate for <i>cluster 2</i> is NOT provided, can you calculate the response rate?<font color=\"#FF0000\"> *</font>. If numbers are not reported, please write 'NA'</font>"), #LH: Text changed
                               choices = c("Yes" = 1, "No" = 2, "NA" = 3),
                               selected = FALSE,
                               multiple = FALSE,
                               selectize = FALSE, size = 3, width = 380),
                   ...
                   br(),
                   br(),
                   textInput(paste0("rrcomment1", redcapdb$id[i]), HTML("Number of individuals who participated in the study<font color=\"#FF0000\"> *</font>"), "", width = 380),
                   #r2_participants_c2
                   textInput(paste0("rrcomment1c2", redcapdb$id[i]), HTML("<font color=\"#0066CC\">Number of individuals in <i>cluster 2</i> who participated in the study</font><font color=\"#FF0000\"> *</font>"), "", width = 380),
                   ...
                   selectInput(paste0("ibselect", redcapdb$id[i]), HTML("Question 3 - Was the assessment of symptoms status adequate?<font color=\"#FF0000\"> *</font><br><span style=\"font-weight:normal\"> - Indicate whether the risk of bias is high, unclear, or low, according to the guidance above:</span>"),
                               ...
                               selectize = FALSE, size = 3, width = 380),
                   #r1_rob_q3_c2
                   selectInput(paste0("ibselectc2", redcapdb$id[i]), HTML("<font color=\"#0066CC\">Question 3 - Was the assessment of symptoms status adequate for <i>cluster 2</i>?<font color=\"#FF0000\"> *</font><br><span style=\"font-weight:normal\"> - Indicate whether the risk of bias is high, unclear, or low, according to the guidance above:</span></font>"),
                               choices = c("High" = 1, "Unclear" = 2, "Low" = 3, "NA" = 4),
                               selected = FALSE,
                               multiple = FALSE,
                               selectize = FALSE, size = 4, width = 380),
  ...
  lapply(
    ...
    FUN = function(j){
      observeEvent(input[[paste0("c", redcapdb$id[j])]], {
        cat("click\n")
        #cluster2 = input[[paste0("try", redcapdb$id[j])]]
        #cluster2 = ifelse(cluster2==1, 1,0)
