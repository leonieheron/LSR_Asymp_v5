...
rob_records <- rob_records[rob_records$record_id < 5296, ]
...
p6 <- occupationalset_rob_trafficlight +
  ggplot2::labs(
    ...
    Selection Bias:
  D1.1: Representativeness of the sample
  D1.2: Characteristics of non-respondents
    Information Bias:
  D2.1: Symptom assessment
  D2.1: Recording of symptoms
    Misclassification bias:
  D3: Classification of asymptomatic status
    Attrition bias:
  D4: Selective reporting of symptoms status")
...
dev.new()
png("q1_2_new.png", width = 1400, height = 2200)
p75
graphics.off()
...
dev.new()
png("q2_new.png", width = 1000, height = 300)
p8
graphics.off()
