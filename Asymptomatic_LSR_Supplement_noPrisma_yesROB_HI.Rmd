...
rob_records <- rob_records[1:166,]


#added a new column HI
df_rob <- rob_records %>%
...
q1_rob <- df_rob %>%
  ...
  filter(quest___1 == 1)  %>%
  select(authoryearId, rob_1, rob_2, rob_3, rob_4, rob_5, rob_6, record_id, quest___1, q3_sar, setting) %>%
  rename(Study = authoryearId, D1 = rob_1, D2 = rob_2, D3 = rob_3, D4 = rob_4,
         D5 = rob_5, D6 = rob_6)
