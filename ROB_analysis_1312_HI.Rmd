...
dev.new()
tiff("test1.tiff", width = 17.78, height = 12.80, units = "cm", res = 600)
...
dev.new()
tiff("test2.tiff", width = 24, height = 26.35, units = "cm", res = 600)
p2
graphics.off()
...
p3 <- communityset_rob_trafficlight +
  ggplot2::labs(
    caption = " ") + 
...
dev.new()
#tiff("test3.tiff", width = 900, height = 520)
tiff("test3.tiff", width = 17.78, height = 17.78, units = "cm", res = 600)
p3
graphics.off()
...
dev.new()
#tiff("test3.tiff", width = 900, height = 710)
tiff("test4.tiff", width = 17.78, height = 23, units = "cm", res = 600)
p4
graphics.off()
...
p5 <- occupationalset_rob_trafficlight +
  ggplot2::labs(
    caption = "
    Domains
...
dev.new()
tiff("test5.tiff", width = 17.78, height = 23, units = "cm", res = 600)
#tiff("test5.tiff", width = 900, height = 620)
p5
graphics.off()
...
dev.new()
tiff("test6.tiff", width = 17.78, height = 15, units = "cm", res = 600)
p6
graphics.off()
...
knitr::include_graphics("C:/Users/hi19u875/Desktop/Asymptomatic_Review_DataIntoRedcap_Everyweeksearch/test1.tiff")
```

```{r, echo = FALSE}
# All defaults
knitr::include_graphics("C:/Users/hi19u875/Desktop/Asymptomatic_Review_DataIntoRedcap_Everyweeksearch/test2.tiff")
```

```{r, echo = FALSE}
# All defaults
knitr::include_graphics("C:/Users/hi19u875/Desktop/Asymptomatic_Review_DataIntoRedcap_Everyweeksearch/test3.tiff")
```

```{r, echo = FALSE}
# All defaults
knitr::include_graphics("C:/Users/hi19u875/Desktop/Asymptomatic_Review_DataIntoRedcap_Everyweeksearch/test4.tiff")
```

```{r, echo = FALSE}
# All defaults
knitr::include_graphics("C:/Users/hi19u875/Desktop/Asymptomatic_Review_DataIntoRedcap_Everyweeksearch/test5.tiff")
```
...
```{r, echo = FALSE}
# All defaults
knitr::include_graphics("C:/Users/hi19u875/Desktop/Asymptomatic_Review_DataIntoRedcap_Everyweeksearch/test6.tiff")
```
