...
![Figure 3. PRISMA 2020 Flow Diagram](PRISMA2020_flowdiagram.png)
***
...
```{r table1_countries, ft.split=TRUE, tab.cap='Table 1. Location of studies contributing data to review questions 1', echo = FALSE}
